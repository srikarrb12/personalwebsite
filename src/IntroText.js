      ...
      <div className="row">
        <div className="col-10" style={{ textAlign: "left" }}>
          ...
          <p className="light">
            ...
            and code through AWS tools and Terraform. I offer excellent
            communication and organizational abilities, along with fluency in
            virtual work and am known for accomplishing objectives with an
            upbeat and positive attitude and efficient time management.
          </p>
        </div>
      </div>
    </>
